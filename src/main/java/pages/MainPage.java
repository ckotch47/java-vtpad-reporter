...
public class MainPage {
    ...
    private By modalPayment = By.xpath(".//div[@class='Text__StyledTextSpan-sc-9bqqn7-0 gUeNhY qa-payment-option-title Preview__StyledTitle-aie99n-0 hVHItB'].//div[@class='Text__StyledTextSpan-sc-9bqqn7-0 gUeNhY qa-payment-option-title Preview__StyledTitle-aie99n-0 hVHItB']/child::node()[last()]");
